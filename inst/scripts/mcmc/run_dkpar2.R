...
## Remove _0 from dkpar_3_6_3-d_0 generated by generate_dkpar.R,
## resulting in folder name dkpar_3_6_3-d, and move to folder mcmc
## nested in simulations folder
...
ARGS <- c(ARGS, list(
  ## exact
  list("bcb-bucb", c(51), path),
  list("bcb-ts", c(51), path),
  list("bcb-ucb", c(54), path),
  ## mcmc
  list("bcb-mcmc-bucb", c(51), path),
  list("bcb-mcmc-ts", c(51), path),
  list("bcb-mcmc-ucb", c(54), path),
  ## hybrid mcmc
